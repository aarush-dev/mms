--
-- NOTE: the database name here must match which is given in the <python_path>/mms/base/configs.py file
--
...
INSERT INTO `users`(`name`, `email`, `password`, `role`, `is_active`) VALUES('admin', 'admin@mms.com', 'admin', 0, 1);
